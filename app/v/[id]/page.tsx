...
export default async function Video({ params }: PageProps) {
    ...
    if (data.status !== 200) {
        ...
        url: `https://bokepjepangindo.pages.dev/v/${file.file_code}`,
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `ReadAction`,
                target: `https://bokepjepangindo.pages.dev/v/${file.file_code}`
            }  
        }
        }
